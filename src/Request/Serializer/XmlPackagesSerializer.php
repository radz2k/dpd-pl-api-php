...
namespace radz2k\Dpd\Request\Serializer;
...
class XmlPackagesSerializer
{
    ...
    public function __construct()
    {
        ...
        $this->xmlEngine->classMap['radz2k\Dpd\Objects\Package'] = [$this, 'mapPackage'];
        $this->xmlEngine->classMap['radz2k\Dpd\Objects\Sender'] = [$this, 'mapAddress'];
        $this->xmlEngine->classMap['radz2k\Dpd\Objects\Receiver'] = [$this, 'mapAddress'];
        $this->xmlEngine->classMap['radz2k\Dpd\Objects\Parcel'] = [$this, 'mapParcel'];
        $this->xmlEngine->classMap['radz2k\Dpd\Objects\Services'] = [$this, 'mapServices'];
    }
